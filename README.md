...
<p align="center">
	<img width="32%" src="./Resources/RMS_Logo.jpg" alt="RMS Logo"> <img width="10%" src="./Resources/CRICK_Logo.png" alt="Crick Logo"> <img width="14%" src="./Resources/Cardiff_Logo.png" alt="Cardiff University Logo"> <img width="10%" src="./Resources/Nikon_Logo.png" alt="Nikon Logo"> <img width="20%" src="./Resources/ucl-logo.png" alt="UCL Logo">
</p>
